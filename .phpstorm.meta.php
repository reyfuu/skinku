...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links./home/reyfuu/skinku/public/storage' => 'string',
...
'filesystems.links./home/reyfuu/skinku/public/storage','logging.default','logging.deprecations.channel','logging.deprecations.trace','logging.channels.stack.driver',
...
'signed','throttle','verified','role','permission',);
        registerArgumentsSet('routes', 'login','password.request','password.email',
'password.reset','password.update','logout','dashboard',
'account.password','purchase-orders.index','purchase-orders.create','purchase-orders.store',
'purchase-orders.show','purchase-orders.cancel','purchase-orders.payment-proof','purchase-orders.status','purchase-orders.shipping',
'purchase-orders.verify-payment','purchase-orders.destroy','inventory.index','inventory.partner-adjust','inventory.minimum',
'inventory.hq-adjust','stock-movements.index','reports.index','reports.chart-data','products.index',
'products.store','products.update','products.destroy','users.index','users.store',
'users.update','users.toggle-status','users.reset-password','users.destroy','audit-logs.index',
'settings.index','permissions.index','permissions.update','stock-movements.mine','storage.local',
'storage.local.upload',);
        registerArgumentsSet('views', 
'audit_logs.index','auth.change-password','auth.forgot-password','auth.login','auth.reset-password',
'dashboard.index','inventory.index','layouts.app','permissions.index','products.index',
'purchase_orders.create','purchase_orders.index','purchase_orders.show','reports.index','settings.index',
'stock_movements.index','users._fields','users.index','welcome','laravel-exceptions-renderer::components.badge',
...
'MAIL_FROM_ADDRESS','MAIL_FROM_NAME','SUPER_ADMIN_NAME','SUPER_ADMIN_EMAIL','SUPER_ADMIN_USERNAME',
'SUPER_ADMIN_PASSWORD','VITE_APP_NAME',);
